...
- Web routes: `POST /auth/google/redirect` (privacy consent required), `GET /auth/google/callback`.
...
1. With credentials in `.env`, open `/login` — Google button appears after accepting privacy policy.
