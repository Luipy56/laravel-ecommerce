...
<head>
    ...
    <meta name="description" content="Materials i solucions de serralleria al teu abast. Compra online a {{ config('app.name') }}.">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="{{ rtrim(config('app.url'), '/') }}">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="{{ config('app.name') }}">
    <meta property="og:title" content="{{ config('app.name') }}">
    <meta property="og:description" content="Materials i solucions de serralleria al teu abast.">
    <meta property="og:url" content="{{ rtrim(config('app.url'), '/') }}">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="{{ config('app.name') }}">
    <meta name="twitter:description" content="Materials i solucions de serralleria al teu abast.">
