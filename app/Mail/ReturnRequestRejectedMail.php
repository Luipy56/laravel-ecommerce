...
class ReturnRequestRejectedMail extends Mailable
{
    use Queueable;
    ...
    {
        return new Envelope(
            subject: __('mail.return_request_rejected.subject', ['id' => $this->returnRequest->order_id]),
        );
    }
    ...
    {
        return new Content(
            html: 'emails.return-request-rejected',
            with: [
