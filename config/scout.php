...
return [
    ...
    |
    | Default `null` keeps PHPUnit/CI working without a cluster. Set
    | SCOUT_DRIVER=elasticsearch when Elasticsearch is available.
    |
    */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Elasticsearch (custom Scout engine)
    |--------------------------------------------------------------------------
    |
    | Third-party Scout drivers do not target Scout 11 yet; this app uses the
    | official elasticsearch/elasticsearch client with a small Engine class.
    | Index bodies are keyed by table name suffix (Scout index name minus prefix).
    |
    */
    ...
    'elasticsearch' => [
        ...
        'refresh_on_write' => filter_var(env('ELASTICSEARCH_REFRESH_ON_WRITE', false), FILTER_VALIDATE_BOOL),
        'index_definitions' => [
            'products' => [
                'mappings' => [
                    'properties' => [
