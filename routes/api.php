...
use App\Http\Controllers\Api\AdminKeyColorController;
...
use App\Http\Controllers\Api\KeyColorController;
...
Route::get('key-colors', [KeyColorController::class, 'index']);
...
Route::middleware(['auth:admin'])->prefix('admin')->group(function () {
    ...
    Route::get('key-colors', [AdminKeyColorController::class, 'index']);
    Route::post('key-colors', [AdminKeyColorController::class, 'store']);
    Route::get('key-colors/{keyColor}', [AdminKeyColorController::class, 'show']);
    Route::put('key-colors/{keyColor}', [AdminKeyColorController::class, 'update']);
    Route::patch('key-colors/{keyColor}/toggle', [AdminKeyColorController::class, 'toggle']);
