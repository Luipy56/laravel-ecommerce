...
ensure_label "to-staging" "5319E7" "Admin Help: autoagents implements and deploys to staging"
ensure_label "waiting for human validation" "C5DEF5" "Admin Help: pending human review before autoagents queue"
echo "Done."
