...
- **Docker:** Development Compose file renamed from **`docker-compose.yml`** to **`docker-compose-dev.yml`**; use **`docker compose -f docker-compose-dev.yml …`** (README, **AGENTS.md**, **testing-verification.mdc**).
