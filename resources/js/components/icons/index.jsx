...
/** Sun icon (e.g. switch to light theme). */
export function IconSun({ className, strokeWidth, ...rest }) {
  return (
    <IconWrapper className={className} strokeWidth={strokeWidth} {...rest}>
      <circle cx="12" cy="12" r="4" strokeWidth={strokeWidth ?? 2} />
      <path
        strokeWidth={strokeWidth ?? 2}
...
/** Moon icon (e.g. switch to dark theme). */
export function IconMoon({ className, strokeWidth, ...rest }) {
  return (
    <IconWrapper className={className} strokeWidth={strokeWidth} {...rest}>
      <path
        strokeWidth={strokeWidth ?? 2}
...
export function IconTag({ className, strokeWidth, ...rest }) {
  return (
    <IconWrapper className={className} strokeWidth={strokeWidth} {...rest}>
      <path strokeWidth={strokeWidth ?? 2} d="M20.59 13.41l-7.17 7.17a2 2 0 01-2.83 0L2 12V2h10l8.59 8.59a2 2 0 010 2.82z" />
      <line x1="7" y1="7" x2="7.01" y2="7" strokeWidth={strokeWidth ?? 2} />
    </IconWrapper>
  );
}
